	...
	content: {
		...
		sections: [
			...
			},
			{
				...
				label: t({
					en: "Go to the showcase",
					fr: "Aller à la vitrine",
					es: "Ir al escaparate",
					"en-GB": "Go to the showcase",
					de: "Zum Schaufenster gehen",
					ja: "ショーケースに移動",
					ko: "쇼케이스로 이동",
					zh: "访问展示",
					it: "Vai alla vetrina",
					pt: "Ir para a vitrine",
					hi: "शोकेस पर जाएं",
					ar: "اذهب إلى العرض",
					ru: "Перейти на витрину",
					tr: "Vitrine git",
					pl: "Przejdź do wizytówki",
					id: "Buka showcase",
					vi: "Đến trang trưng bày",
					uk: "Перейти до вітрини",
				}),
			},
		],
		github: {
