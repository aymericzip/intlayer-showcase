			...
			<div className="flex flex-col items-center justify-center gap-5 py-6 px-4">
				{submitError ? (
					<>
						...
						<span className="text-neutral text-sm text-center max-w-full overflow-hidden text-clip">
							{submitError}
						</span>
						<div className="m-auto aspect-square rounded-full bg-error/30 p-5 mt-4">
					...
					<>
						...
						<div className="m-auto aspect-square rounded-full bg-success/30 p-5 mt-4">
					...
					<>
						...
						<div className="flex flex-col w-full gap-4 my-4 max-w-md border-l border-l-neutral/30 pl-4">
							<ul className="text-sm space-y-3 text-neutral">
								<StepItem
